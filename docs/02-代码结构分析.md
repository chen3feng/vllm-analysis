...
版本号由 `setuptools-scm` 自动从 git 标签生成（[pyproject.toml:50-51](../pyproject.toml#L50)）。CLI 入口点 `vllm` 指向 [entrypoints/cli/main.py](../vllm/vllm/entrypoints/cli/main.py)（[pyproject.toml:44](../pyproject.toml#L44)）。
...
平台层加载（[platforms/interface.py:242-250](../vllm/vllm/platforms/interface.py#L242)）：
...
算子包装（[_custom_ops.py](../vllm/vllm/_custom_ops.py)，3900+ 行）—— 所有 Python 代码通过此文件调用编译后的内核：
...
| 功能区域 | 行号范围 | 算子示例 |
|----------|---------|---------|
| Attention | [L135-290](../vllm/vllm/_custom_ops.py#L135) | `paged_attention_v1/v2`、`merge_attn_states` |
| Position Encoding | [L299-360](../vllm/vllm/_custom_ops.py#L299) | `rotary_embedding` |
| Normalization | [L316-328](../vllm/vllm/_custom_ops.py#L316) | `rms_norm`、`fused_add_rms_norm` |
| 量化 GEMM | [L600-1600](../vllm/vllm/_custom_ops.py#L600) | `awq_gemm`、`gptq_gemm`、`marlin_gemm`、`cutlass_scaled_mm` |
| FP4 | [L1600-1900](../vllm/vllm/_custom_ops.py#L1600) | `scaled_fp4_quant`、`cutlass_fp4_moe_mm` |
| FP8 | [L1905+](../vllm/vllm/_custom_ops.py#L1905) | `scaled_fp8_quant` |
| MoE | [L2242+](../vllm/vllm/_custom_ops.py#L2242) | `topk_softmax`、`moe_align_block_size`、`dsv3_router_gemm` |
