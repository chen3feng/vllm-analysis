...
[llm.py:194-402](../vllm/vllm/entrypoints/llm.py#L194)
...
[api_server.py:108-136](../vllm/vllm/entrypoints/openai/api_server.py#L108)
...
[arg_utils.py:412-716](../vllm/vllm/engine/arg_utils.py#L412)

`EngineArgs` 是一个包含所有可配置字段的大 dataclass（约 300 个字段），其核心方法是 `create_engine_config()`（[arg_utils.py:1697-2252](../vllm/vllm/engine/arg_utils.py#L1697)），按顺序生成以下子配置：

| 子配置 | 行号 | 关键职责 |
|--------|------|---------|
| **DeviceConfig** | [L1709](../vllm/vllm/engine/arg_utils.py#L1709) | 设备类型（cuda/rocm/cpu） |
| **ModelConfig** | [L1730](../vllm/vllm/engine/arg_utils.py#L1730) | 模型名、dtype、tokenizer、`max_model_len`（可为 `-1` 自动适配） |
| **CacheConfig** | [L1754](../vllm/vllm/engine/arg_utils.py#L1754) | `block_size`（默认 16，此时为占位值）、`gpu_memory_utilization`（默认 0.9）、`enable_prefix_caching` |
| **ParallelConfig** | [L1957](../vllm/vllm/engine/arg_utils.py#L1957) | TP/PP/DP/CP 并行度 |
| **SchedulerConfig** | [L2028](../vllm/vllm/engine/arg_utils.py#L2028) | `max_num_batched_tokens`、`max_num_seqs`、调度策略 |
| **LoadConfig** | — | 模型加载方式（safetensors、dummy、bitsandbytes 等） |
| **VllmConfig** | [L2224](../vllm/vllm/engine/arg_utils.py#L2224) | 聚合所有子配置 |

> `block_size` 在此时只是**占位值** —— 真正的值在后续 `update_block_size_for_backend()` 和 `get_kv_cache_configs()` 阶段才确定。

[AsyncEngineArgs](../vllm/vllm/engine/arg_utils.py#L2568) 继承自 `EngineArgs`，额外增加了 `enable_log_requests` 等异步特有字段。
...
[llm_engine.py:50-177](../vllm/vllm/v1/engine/llm_engine.py#L50)
...
[core_client.py:80-103](../vllm/vllm/v1/engine/core_client.py#L80)
...
多进程模式下，`MPClient.__init__()`（[core_client.py:473-611](../vllm/vllm/v1/engine/core_client.py#L473)）的核心流程：
...
[core.py:97-232](../vllm/vllm/v1/engine/core.py#L97)
...
[abstract.py:48-92](../vllm/vllm/v1/executor/abstract.py#L48)
...
[uniproc_executor.py:46-66](../vllm/vllm/v1/executor/uniproc_executor.py#L46)
...
[multiproc_executor.py:109-246](../vllm/vllm/v1/executor/multiproc_executor.py#L109)

为每个 GPU 创建一个 `WorkerProc` 后台进程（[multiproc_executor.py:579-637](../vllm/vllm/v1/executor/multiproc_executor.py#L579)），每个进程内执行相同的 `init_worker → init_device → load_model` 序列。与 UniProc 的区别仅在于额外增加了：
- Worker 之间通过消息队列广播 `SchedulerOutput` / `ModelRunnerOutput`
- Worker monitor 线程检测健康状态

### 7.4 WorkerWrapperBase：解析 Worker 类

[worker_base.py:230-313](../vllm/vllm/v1/worker/worker_base.py#L230)
...
[gpu_worker.py:236-331](../vllm/vllm/v1/worker/gpu_worker.py#L236)
...
[gpu_worker.py:335-349](../vllm/vllm/v1/worker/gpu_worker.py#L335)
...
[gpu_model_runner.py:5032-5181](../vllm/vllm/v1/worker/gpu_model_runner.py#L5032)
...
[interface.py:470-506](../vllm/vllm/platforms/interface.py#L470)
...
`EngineCore._initialize_kv_caches()`（[core.py:235-313](../vllm/vllm/v1/engine/core.py#L235)）编排了整个 KV cache 的内存规划、profiling 和分配。
...
入口：[gpu_model_runner.py:7291](../vllm/vllm/v1/worker/gpu_model_runner.py#L7291)
...
对每个 worker 发起 `determine_available_memory()`（[gpu_worker.py:358-510](../vllm/vllm/v1/worker/gpu_worker.py#L358)）：
...
[kv_cache_utils.py:1945-2077](../vllm/vllm/v1/core/kv_cache_utils.py#L1945)
...
每个 worker 的 `GPUModelRunner.initialize_kv_cache()`（[gpu_model_runner.py:7135-7192](../vllm/vllm/v1/worker/gpu_model_runner.py#L7135)）：
...
[core.py:144-146](../vllm/vllm/v1/engine/core.py#L144)

调用 [resolve_kv_cache_block_sizes()](../vllm/vllm/v1/core/kv_cache_utils.py#L571)（[kv_cache_utils.py:571-634](../vllm/vllm/v1/core/kv_cache_utils.py#L571)）：
...
[core.py:148-156](../vllm/vllm/v1/engine/core.py#L148)
...
[scheduler.py:64-277](../vllm/vllm/v1/core/sched/scheduler.py#L64)
...
[kv_cache_manager.py:110-180](../vllm/vllm/v1/core/kv_cache_manager.py#L110)
...
KVCacheCoordinator 选择逻辑（[kv_cache_coordinator.py:610-658](../vllm/vllm/v1/core/kv_cache_coordinator.py#L610)）：

| 条件 | Coordinator | 行号 |
|------|-----------|------|
| Prefix caching 禁用 | `KVCacheCoordinatorNoPrefixCache` | [L276](../vllm/vllm/v1/core/kv_cache_coordinator.py#L276) |
| 1 个 KV cache group | `UnitaryKVCacheCoordinator` | [L324](../vllm/vllm/v1/core/kv_cache_coordinator.py#L324) |
| 多个 KV cache group | `HybridKVCacheCoordinator` | [L392](../vllm/vllm/v1/core/kv_cache_coordinator.py#L392) |

### 9.3 BlockPool.__init__()

[block_pool.py:130-182](../vllm/vllm/v1/core/block_pool.py#L130)
...
每个 `KVCacheBlock`（[kv_cache_utils.py:116](../vllm/vllm/v1/core/kv_cache_utils.py#L116)）初始化时 `ref_cnt=0`，通过双向链表指针串联成空闲队列。
...
基类 [single_type_kv_cache_manager.py:31](../vllm/vllm/v1/core/single_type_kv_cache_manager.py#L31)，各子类的实现见下表：

| Manager | 行号 | 对应的 Spec |
|---------|------|------------|
| `FullAttentionManager` | [L481](../vllm/vllm/v1/core/single_type_kv_cache_manager.py#L481) | FullAttentionSpec, MLAAttentionSpec |
| `SlidingWindowManager` | [L542](../vllm/vllm/v1/core/single_type_kv_cache_manager.py#L542) | SlidingWindowSpec |
...
| 组件 | 文件 | 核心行号 |
|------|------|---------|
| LLM 入口 | [llm.py](../vllm/vllm/entrypoints/llm.py) | [194-402](../vllm/vllm/entrypoints/llm.py#L194) |
| API 服务器入口 | [api_server.py](../vllm/vllm/entrypoints/openai/api_server.py) | [108-136](../vllm/vllm/entrypoints/openai/api_server.py#L108) |
| 配置解析 | [arg_utils.py](../vllm/vllm/engine/arg_utils.py) | [412-716](../vllm/vllm/engine/arg_utils.py#L412), [1697-2252](../vllm/vllm/engine/arg_utils.py#L1697) |
| LLMEngine | [llm_engine.py](../vllm/vllm/v1/engine/llm_engine.py) | [50-177](../vllm/vllm/v1/engine/llm_engine.py#L50) |
| AsyncLLM | [async_llm.py](../vllm/vllm/v1/engine/async_llm.py) | [73-229](../vllm/vllm/v1/engine/async_llm.py#L73) |
| EngineCoreClient | [core_client.py](../vllm/vllm/v1/engine/core_client.py) | [80-103](../vllm/vllm/v1/engine/core_client.py#L80), [274-365](../vllm/vllm/v1/engine/core_client.py#L274), [473-611](../vllm/vllm/v1/engine/core_client.py#L473) |
| EngineCore | [core.py](../vllm/vllm/v1/engine/core.py) | [97-232](../vllm/vllm/v1/engine/core.py#L97), [235-313](../vllm/vllm/v1/engine/core.py#L235) |
| Executor 基类 | [abstract.py](../vllm/vllm/v1/executor/abstract.py) | [48-137](../vllm/vllm/v1/executor/abstract.py#L48) |
| UniProcExecutor | [uniproc_executor.py](../vllm/vllm/v1/executor/uniproc_executor.py) | [46-66](../vllm/vllm/v1/executor/uniproc_executor.py#L46) |
| MultiprocExecutor | [multiproc_executor.py](../vllm/vllm/v1/executor/multiproc_executor.py) | [109-246](../vllm/vllm/v1/executor/multiproc_executor.py#L109), [579-637](../vllm/vllm/v1/executor/multiproc_executor.py#L579) |
| WorkerWrapperBase | [worker_base.py](../vllm/vllm/v1/worker/worker_base.py) | [230-313](../vllm/vllm/v1/worker/worker_base.py#L230) |
| GPUWorker | [gpu_worker.py](../vllm/vllm/v1/worker/gpu_worker.py) | [236-349](../vllm/vllm/v1/worker/gpu_worker.py#L236), [358-569](../vllm/vllm/v1/worker/gpu_worker.py#L358) |
| GPUModelRunner | [gpu_model_runner.py](../vllm/vllm/v1/worker/gpu_model_runner.py) | [418-897](../vllm/vllm/v1/worker/gpu_model_runner.py#L418), [5032-5181](../vllm/vllm/v1/worker/gpu_model_runner.py#L5032), [7135-7192](../vllm/vllm/v1/worker/gpu_model_runner.py#L7135) |
| KVCacheConfig | [kv_cache_utils.py](../vllm/vllm/v1/core/kv_cache_utils.py) | [1945-2077](../vllm/vllm/v1/core/kv_cache_utils.py#L1945), [571-634](../vllm/vllm/v1/core/kv_cache_utils.py#L571) |
| BlockPool | [block_pool.py](../vllm/vllm/v1/core/block_pool.py) | [130-182](../vllm/vllm/v1/core/block_pool.py#L130) |
| KVCacheCoordinator | [kv_cache_coordinator.py](../vllm/vllm/v1/core/kv_cache_coordinator.py) | [28-658](../vllm/vllm/v1/core/kv_cache_coordinator.py#L28) |
| KVCacheManager | [kv_cache_manager.py](../vllm/vllm/v1/core/kv_cache_manager.py) | [110-180](../vllm/vllm/v1/core/kv_cache_manager.py#L110) |
| SingleTypeKVCacheManager | [single_type_kv_cache_manager.py](../vllm/vllm/v1/core/single_type_kv_cache_manager.py) | [31-149](../vllm/vllm/v1/core/single_type_kv_cache_manager.py#L31) |
| Scheduler | [scheduler.py](../vllm/vllm/v1/core/sched/scheduler.py) | [64-277](../vllm/vllm/v1/core/sched/scheduler.py#L64) |
| Platform block_size hook | [interface.py](../vllm/vllm/platforms/interface.py) | [470-506](../vllm/vllm/platforms/interface.py#L470) |
